...
INSERT INTO practicatest.`users` (id, username, password, register_date, role) VALUES ('12', 'rotaru', 'pass12', '2009-3-31', 'APPLICANT');
INSERT INTO practicatest.`users` (id, username, password, register_date, role) VALUES ('13', 'clima', 'pass13', '2009-7-31', 'RECRUITER');

INSERT INTO practicatest.`companies` (id, title, domain, about, phone_number, email, img_path) VALUES ('1', 'IUCOSOFT', 'IT', 'We work in JAVA', '060111111', 'email@iucosoft.com', 'img1.png');
...
INSERT INTO practicatest.`companies` (id, title, domain, about, phone_number, email, img_path) VALUES ('6', 'Climatehnic', 'ENGINEERING', 'Good company', '079783222', 'climatehnic@gmail.com', 'img6.jpg');
...
INSERT INTO practicatest.`applicants` (id, name, surname, age, a_status, domain, cv, user_id, email, phone_number) VALUES ('6', 'Rotaru', 'Dimitrie', '50', 'UNEMPLOYED', 'FOOD', 'cv6.pdf', '12', 'rotaru@gmail.com', '060567870');
...
INSERT INTO practicatest.`recruiters` (id, name, surname, user_id, company_id, email) VALUES ('3', 'Iurie', 'Coropceanu', '7', '1', 'iurie.coropceanu@iucosoft.com');
...
INSERT INTO practicatest.`programmes` (id, title, domain, start_data, duration, company_id, duties, qualifications, benefits, location, paid) VALUES ('6', 'Crazy', 'DESIGN', '2021-2-14', '3 weeks', '5', 'Do crazy stuff', 'No qualifications', 'Do crazy stuff', 'Causeni', '0');
