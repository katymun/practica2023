 ...
 */
package com.iucosoft.stagiimdweb.filters;
...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            //wrappedRequest.setAttribute("error", t.getMessage());
            // DE SCHIMBAT LA PAGINA DE EROARE
            path = "../showloginserv?error="+t.getMessage();
