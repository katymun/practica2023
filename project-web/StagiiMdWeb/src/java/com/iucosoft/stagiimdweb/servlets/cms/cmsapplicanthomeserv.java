 ...
 * @author munka
 */
@WebServlet(name = "cmsapplicanthomeserv", urlPatterns = {"/cms/cmsapplicanthomeserv"})
public class cmsapplicanthomeserv extends HttpServlet {
...
//            request.setAttribute("internshipListTopFive", internshipListTopFive);
        ...
        request.getRequestDispatcher("../stagii/home_applicant.jsp").forward(request, response);
