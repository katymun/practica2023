...
//        List<Applicant> applicantList = applicantDAO.findByName("name");
        ...
        String mainAttribute = (String) request.getServletContext().getAttribute("mainAttribute");
        request.setAttribute("mainAttributeServ", mainAttribute);
        
        //de exemplu ma aflu in companyServlet
//        CompanyDAOIntf companyDao = sc.getAttribute("companyDao");
