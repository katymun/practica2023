 ...
 * @author munka
 */
@WebServlet(name = "cmsapplicantcompaniesserv", urlPatterns = {"/cms/cmsapplicantcompaniesserv"})
public class cmsapplicantcompaniesserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("../stagii/companies_applicant.jsp").forward(request, response);    
    }
