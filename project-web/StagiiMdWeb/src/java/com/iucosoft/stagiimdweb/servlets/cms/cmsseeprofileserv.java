 ...
 * @author munka
 */
@WebServlet(name = "cmsseeprofileserv", urlPatterns = {"/cms/cmsseeprofileserv"})
public class cmsseeprofileserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        User sessionUser = (User) session.getAttribute("mainUser");
        int idUser = sessionUser.getId();

        try {
            Applicant sessionApplicant = applicantDao.findByUserId(idUser);
            session.setAttribute("sessionApplicant", sessionApplicant);
        ...
        request.getRequestDispatcher("../stagii/seeprofile.jsp").forward(request, response);
    }
