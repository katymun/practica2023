 ...
 * @author munka
 */
@WebServlet(name = "cmsinternshipsfoundserv", urlPatterns = {"/cms/cmsinternshipsfoundserv"})
public class cmsinternshipsfoundserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("../stagii/internships_found_applicant.jsp").forward(request, response);
    }
