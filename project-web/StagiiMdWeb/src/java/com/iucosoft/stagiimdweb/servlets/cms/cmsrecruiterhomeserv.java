 ...
 * @author munka
 */
@WebServlet(name = "cmsrecruiterhomeserv", urlPatterns = {"/cms/cmsrecruiterhomeserv"})
public class cmsrecruiterhomeserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("../stagii/generalcompany.jsp").forward(request, response);
    }
