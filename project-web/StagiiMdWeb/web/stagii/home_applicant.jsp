...
<section class="homepage-internships-section">
    ...
    <!--    <div class="homepage-companies1">
            <a href="internship_details.html?ID_INTERNSHIP=" class="internships-found-company it-companies1">
    ...
    <div class="homepage-container1">
        <div class="homepage-vertical-center">
            <a href="cmsapplicantinternshipsserv" class="homepage-more-internships">
