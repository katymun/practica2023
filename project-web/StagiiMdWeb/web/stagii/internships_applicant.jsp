...
<html lang="en">
    ...
    <div class="internship-button">
        <div class="internship-form-group">
            ...
            <div class="internship-col">
                <form action="cmsinternshipsfoundserv">
 ...
 <div class="internship-white-boxes">
        <a href="cmsinternshipsbydomainserv?domain=IT" class="internship-white-box-link" onmouseover="changeITImage()" onmouseout="revertITImage()">
        ...
        <a href="cmsinternshipsbydomainserv?domain=Design" class="internship-white-box-link"onmouseover="changeDesignImage()" onmouseout="revertDesignImage()">
            <div class="internship-white-box">
                <img id="Design" src="../images/Design sign.svg"  class="internship-box-image2">
                <p class="internship-box-text">Design</p>
            </div>
        </a>
        <a href="cmsinternshipsbydomainserv?domain=Marketing" class="internship-white-box-link"onmouseover="changeMarketingImage()" onmouseout="revertMarketingImage()">
            <div class="internship-white-box">
                <img id="Marketing" src="../images/Marketing sign.svg"  class="internship-box-image3">
                <p class="internship-box-text">Marketing</p>
            </div>
        </a>
        <a href="cmsinternshipsbydomainserv?domain=Management" class="internship-white-box-link"onmouseover="changeManagementImage()" onmouseout="revertManagementImage()">
            <div class="internship-white-box">
                <img id="Management" src="../images/Management sign.svg"  class="internship-box-image4">
                <p class="internship-box-text">Management</p>
            </div>
        </a>
<a href="cmsinternshipsbydomainserv?domain=Telecommunications" class="internship-white-box-link" onmouseover="changeTelecommunicationsImage()" onmouseout="revertTelecommunicationsImage()">
    <div class="internship-white-box">
    ...
    <div class="internship-white-boxes2">
        <a href="cmsinternshipsbydomainserv?domain=Logistics" class="internship-white-box-link"onmouseover="changeLogisticsImage()" onmouseout="revertLogisticsImage()">
            <div class="internship-white-box">
                <img id="Logistics" src="../images/Logistics sign.svg" class="internship-box-image6">
                <p class="internship-box-text">Logistics</p>
            </div>
        </a>
        <a href="cmsinternshipsbydomainserv?domain=Sales" class="internship-white-box-link"onmouseover="changeSalesImage()" onmouseout="revertSalesImage()">
            <div class="internship-white-box">
                <img id="Sales" src="../images/Sales sign.svg" class="internship-box-image7">
                <p class="internship-box-text">Sales</p>
            </div>
        </a>
        <a href="cmsinternshipsbydomainserv?domain=Accounting" class="internship-white-box-link"onmouseover="changeAccountingImage()" onmouseout="revertAccountingImage()">
            <div class="internship-white-box">
                <img id="Accounting" src="../images/Accounting sign.svg" class="internship-box-image8">
                <p class="internship-box-text">Accounting</p>
            </div>
        </a>
<a href="cmsinternshipsbydomainserv?domain=Banking" class="internship-white-box-link" onmouseover="changeBanksImage()" onmouseout="revertBanksImage()">
    <div class="internship-white-box">
        <img id="Banks" src="../images/Banks sign.svg" class="internship-box-image9">
        <p class="internship-box-text">Banking</p>
    </div>
</a>
        <a href="cmsinternshipsbydomainserv?domain=Medicine" class="internship-white-box-link"onmouseover="changeMedicineImage()" onmouseout="revertMedicineImage()">
    <div class="internship-white-box">
