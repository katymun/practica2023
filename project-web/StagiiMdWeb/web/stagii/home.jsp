        ...
        <div class="homepage-left">
            ...
            <div class="homepage-form-group">
                ...
                <div class="homepage-col">
                    <input id="" name="" type="text" placeholder="Search for an internship" class="homepage-input homepage-custom-input" >
