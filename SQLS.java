public class SQLS {
    ...
    // update-uri
    String USERS_UPDATE = "UPDATE useri SET LOGIN=?, PASSWORD=?, DATA_CONEXIUNII=? WHERE ID=?";

    String APPLICANTS_UPDATE = "UPDATE applicants SET NUME=?, PRENUME=?, AGE=?, STATUT=?, DOMAIN=?, CV=?, USER_ID=?, EMAIL=?, PHONE_NUMBER=? WHERE ID=?";

    String RECRUITERS_UPDATE = "UPDATE recruiters SET NUME=?, PRENUME=?, USER_ID=?, COMPANY_ID, EMAIL=? WHERE ID=?";

    String COMPANIES_UPDATE = "UPDATE companies SET TITLE=?, DOMAIN=?, ABOUT=?, PHONE_NUMBER=?, EMAIL=? WHERE ID=?";

    String APPLICATIONS_UPDATE = "UPDATE applications SET APPLICANT_ID=?, PROGRAMME_ID=?, APPLICATION_DATE=?, CV=?, PHONE_NUMBER=?, EMAIL=? WHERE ID=?";

    String PROGRAMMES_UPDATE = "UPDATE programmes SET TITLE=?, DOMAIN=?, START_DATA=?, DURATION=?, ABOUT=?, COMPANY_ID=?  WHERE ID=?";

    //delete-uri
    String USERS_DELETE = "DELETE FROM USERI WHERE ID=?";
    ...
    //find all
    String FIND_ALL_USERS = "SELECT * FROM USERI";
    ...
    String FIND_ALL_PROGARMMES = "SELECT * FROM PROGARMMES";

    //find by id
    String FIND_USER_BY_ID = "SELECT * FROM useri WHERE ID=?";
